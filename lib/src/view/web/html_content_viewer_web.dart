...
import 'package:flutter_super_html_viewer/src/widgets/web/html_content_viewer_widget_web.dart';
...
class HtmlContentViewer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (kIsWeb) {
      return HtmlContentViewerWidget(
      ...
      return const Text(
          'Non-Flutter Web environment detected, please make sure you are importing package:flutter_super_html_viewer/flutter_super_html_viewer.dart');
    }
  }
}
